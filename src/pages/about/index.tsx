  ...
  const education = [
    {
      ...
      period: "3 Years",
      description:
        "Focused on core electrical engineering principles, circuit design, and systems analysis.",
    },
  ];
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-6">
              ...
              <div className="md:w-2/3">
                ...
                <p className="text-foreground-600">
                  My expertise lies in designing efficient database schemas,
                  implementing security best practices, and optimizing
                  application performance. I'm constantly exploring new
