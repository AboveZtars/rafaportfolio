...
const ChatbotPage: React.FC = () => {
  ...
  const generateResponse = (text: string): string => {
    ...
    } else if (lowerText.includes("technologies") || lowerText.includes("tech stack") || lowerText.includes("skills")) {
    ...
    } else if (lowerText.includes("goals") || lowerText.includes("future") || lowerText.includes("career")) {
        ...
        <Card className="bg-content1 mb-8">
          <CardBody className="p-0">
            ...
            <div className="p-4 border-b border-divider flex items-center">
              ...
              />
              <div>
                <p className="font-medium">Rafael's Assistant</p>
            ...
            <div className="px-4 py-3 border-t border-divider overflow-x-auto">
              <p className="text-sm text-foreground-500 mb-2">Suggested questions:</p>
